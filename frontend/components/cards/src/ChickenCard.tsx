          ...
          <Row>
            ...
            <Column alignItems='flex-start'>
              ...
              <Text as='h3' color='black' fontFamily='text' fontWeight='bold' fontSize='average'>
                {intl.formatMessage(messages.tasteChicken)}
              </Text>
              <Layout flexBasis={15} />
              <Box width={108}>
                <Text color='darkGray' fontFamily='text' fontWeight='bold' fontSize='small'>
                  {intl.formatMessage(messages.portionNumberChicken)}
                </Text>
                <Text
                  color='darkGray'
                  fontFamily='text'
              ...
              <Box width={130}>
                <Text color='darkGray' fontFamily='text' fontWeight='bold' fontSize='small'>
                  {intl.formatMessage(messages.mouseNumberChicken)}
                </Text>
                <Text
                  color='darkGray'
                  fontFamily='text'
                  ...
                  pl={1}
                >
                  {intl.formatMessage(messages.mouseChicken)}
                </Text>
              </Box>
            </Column>
          </Row>
      ...
      <Row justifyContent='center'>
        ...
        >
          {activeCard
            ...
            : disabled
            ? intl.formatMessage(messages.cardDisabledChicken)
