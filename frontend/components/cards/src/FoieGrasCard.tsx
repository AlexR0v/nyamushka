          ...
          <Row>
            ...
            <Column alignItems='flex-start'>
              ...
              <Text as='h3' color='black' fontFamily='text' fontWeight='bold' fontSize='average'>
                {intl.formatMessage(messages.tasteFoieGras)}
              </Text>
              <Layout flexBasis={15} />
              <Box width={108}>
                <Text color='darkGray' fontFamily='text' fontWeight='bold' fontSize='small'>
                  {intl.formatMessage(messages.portionNumberFoieGras)}
                </Text>
                <Text
                  color='darkGray'
                  fontFamily='text'
              ...
              <Box width={130}>
                <Text color='darkGray' fontFamily='text' fontWeight='normal' fontSize='small'>
                  {intl.formatMessage(messages.mouseFoieGras)}
                </Text>
              </Box>
            </Column>
          </Row>
      ...
      <Row justifyContent='center'>
        ...
        >
          {activeCard
            ...
            : disabled
            ? intl.formatMessage(messages.cardDisabledFoieGras)
